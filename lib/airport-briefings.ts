...
export const demoAirportBriefings: AirportBriefing[] = [
  {
    content: [
      "## Development A",
      "",
      "Headline: Airports are prioritizing automation that reduces operational friction.",
      "",
      "Summary: Airport operators continue to focus on baggage visibility, passenger processing, security automation, and infrastructure data that can make daily operations more predictable.",
      "",
      "Why it matters: The strongest airport automation projects are no longer isolated pilots. They connect operational pain points with measurable gains in flow, reliability, and capacity.",
      "",
      "Source URL: https://www.in-connect.app/intelligence/airport-automation",
      "",
      "## Development B",
      "",
      "Headline: Baggage automation remains a core investment signal.",
      "",
      "Summary: RFID, automatic tag reading, sortation control, and better BHS data are becoming central to airport modernization conversations.",
      "",
      "Why it matters: Baggage performance affects airline coordination, passenger trust, turnaround pressure, and airport resilience during peak demand.",
      "",
      "Source URL: https://www.in-connect.app/intelligence/airport-automation",
      "",
      "## Development C",
      "",
      "Headline: Passenger processing automation is moving toward integrated identity journeys.",
      "",
      "Summary: Self-service, biometrics, e-gates, and passenger-flow analytics are increasingly linked to wider terminal planning and security workflows.",
      "",
      "Why it matters: Airports need faster processing without making the passenger journey feel fragmented or difficult to manage.",
      "",
      "Source URL: https://www.in-connect.app/intelligence/airport-automation",
    ].join("\n"),
