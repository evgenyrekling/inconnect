...
export const demoAirportBriefings: AirportBriefing[] = [
  {
    content: [
      ...
      "## What Happened?",
      "",
      "Airport operators continue to prioritize baggage automation as pressure grows around peak capacity, transfer reliability, and passenger experience. The strongest signals are around RFID baggage tracking, automatic tag reading, sortation visibility, and better integration between baggage handling systems and operational control rooms.",
      "",
      "## Why It Matters",
      "",
      "Baggage performance affects airline coordination, passenger trust, turnaround pressure, and airport resilience. Better automation can help airports move from reactive exception handling toward more predictable flow management.",
      "",
      "## Key Takeaway",
      "",
      "Baggage automation remains one of the clearest operational business cases for smart airport investment.",
      "",
      "## Original Source",
      "",
      "Source Name: INConnect Intelligence",
      "Source URL: https://www.in-connect.app/intelligence/airport-automation",
      "Open Article: https://www.in-connect.app/intelligence/airport-automation",
    ].join("\n"),
