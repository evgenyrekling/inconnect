...
export const metadata: Metadata = {
  title: "My Intelligence | INConnect",
  description: "View your INConnect intelligence subscriptions and briefings.",
  robots: {
    follow: false,
    index: false,
  },
      ...
      <section className="px-5 py-16 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-3xl rounded-lg border border-[#D9DDE3] bg-white p-8 shadow-[0_8px_24px_rgba(10,25,47,0.05)]">
          ...
          <p className="mt-4 text-sm leading-6 text-[#666666]">
            Your saved intelligence streams will appear here as account features
            expand.
          </p>
          <Link
