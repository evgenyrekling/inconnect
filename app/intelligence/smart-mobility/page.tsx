...
export default function SmartMobilityIntelligencePage() {
  return (
      ...
      <section className="bg-white px-5 py-12 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-5xl">
          ...
          <h1 className="mt-3 text-4xl font-semibold leading-tight text-[#191919] sm:text-5xl">
            Smart Mobility Daily
          </h1>
          <p className="mt-5 max-w-3xl text-base leading-7 text-[#666666] sm:text-lg">
            Daily signals across connected transport, urban mobility, fleets,
            logistics, autonomous systems, and smart infrastructure.
          </p>
